const { SecurityProperties } = require("./securityProperties.class");
const createModel = require("./securityProperties.model");
const hooks = require("./securityProperties.hooks");
...
module.exports = function (app) {
  ...
  app.use("/securityProperties", new SecurityProperties(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("securityProperties");

  // Get the schema of the collections 
  app.get("/securityPropertiesSchema", function (request, response) {
