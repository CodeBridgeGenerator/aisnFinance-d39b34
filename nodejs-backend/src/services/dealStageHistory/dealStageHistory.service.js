const { DealStageHistory } = require("./dealStageHistory.class");
const createModel = require("./dealStageHistory.model");
const hooks = require("./dealStageHistory.hooks");
...
module.exports = function (app) {
  ...
  app.use("/dealStageHistory", new DealStageHistory(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("dealStageHistory");

  // Get the schema of the collections 
  app.get("/dealStageHistorySchema", function (request, response) {
