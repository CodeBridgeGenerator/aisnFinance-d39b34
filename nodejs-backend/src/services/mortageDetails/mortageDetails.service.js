const { MortageDetails } = require("./mortageDetails.class");
const createModel = require("./mortageDetails.model");
const hooks = require("./mortageDetails.hooks");
...
module.exports = function (app) {
  ...
  app.use("/mortageDetails", new MortageDetails(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("mortageDetails");

  // Get the schema of the collections 
  app.get("/mortageDetailsSchema", function (request, response) {
