const { BusinessDetails } = require("./businessDetails.class");
const createModel = require("./businessDetails.model");
const hooks = require("./businessDetails.hooks");
...
module.exports = function (app) {
  ...
  app.use("/businessDetails", new BusinessDetails(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("businessDetails");

  // Get the schema of the collections 
  app.get("/businessDetailsSchema", function (request, response) {
