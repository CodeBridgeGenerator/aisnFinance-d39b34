const { AssetsLiabilities } = require("./assetsLiabilities.class");
const createModel = require("./assetsLiabilities.model");
const hooks = require("./assetsLiabilities.hooks");
...
module.exports = function (app) {
  ...
  app.use("/assetsLiabilities", new AssetsLiabilities(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("assetsLiabilities");

  // Get the schema of the collections 
  app.get("/assetsLiabilitiesSchema", function (request, response) {
