...
import seederData from "./assetsLiabilities.seeder.json";
...
const AssetsLiabilitiesSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(AssetsLiabilitiesSeederDialogComponent);
