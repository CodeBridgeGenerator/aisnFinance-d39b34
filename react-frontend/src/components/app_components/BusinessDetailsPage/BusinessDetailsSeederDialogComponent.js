...
import seederData from "./businessDetails.seeder.json";
...
const BusinessDetailsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(BusinessDetailsSeederDialogComponent);
