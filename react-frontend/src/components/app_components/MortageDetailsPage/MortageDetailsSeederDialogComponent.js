...
import seederData from "./mortageDetails.seeder.json";
...
const MortageDetailsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(MortageDetailsSeederDialogComponent);
