  ...
  const [isHelpSidebarVisible, setHelpSidebarVisible] = useState(false);
    ...
    useEffect(() => {
        ...
        client
            ...
            ? res.clientId.map((elem) => ({ _id: elem._id, userId: elem.userId }))
            : res.clientId
                ? [{ _id: res.clientId._id, userId: res.clientId.userId }]
                : [];
  ...
  const copyPageLink = () => {
    ...
    return (
        ...
        <div className="col-12 flex flex-column align-items-center">
            ...
            <div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Segment</label><p className="m-0 ml-3" >{_entity?.segment}</p></div>
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Current Stage</label><p className="m-0 ml-3" >{_entity?.currentStage}</p></div>
