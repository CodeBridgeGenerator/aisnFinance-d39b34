...
import seederData from "./dealStageHistory.seeder.json";
...
const DealStageHistorySeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(DealStageHistorySeederDialogComponent);
