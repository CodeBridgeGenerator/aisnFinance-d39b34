...
import seederData from "./securityProperties.seeder.json";
...
const SecurityPropertiesSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(SecurityPropertiesSeederDialogComponent);
